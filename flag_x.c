...
/*   Updated: 2020/08/03 23:15:19 by juan-gon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_x(t_printf *data, unsigned int nb, char type)
{
	...
	ft_pres_x(space, zero, data, nb, type);
}